    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(c -> c
                        ...
                        .requestMatchers(HttpMethod.PATCH, "/api/messages/**").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/messages/conversations").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/messages/email-message-attachment").permitAll()
                        ...
                        .requestMatchers(HttpMethod.POST, "/api/user-documents/email-document").permitAll()
                        ...
                        .hasAnyAuthority(Roles.BUSINESS.name(), Roles.ADMIN.name())
