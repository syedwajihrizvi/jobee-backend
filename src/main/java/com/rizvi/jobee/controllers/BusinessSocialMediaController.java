...
import com.rizvi.jobee.services.BusinessSocialMediaService;
...
public class BusinessSocialMediaController {
    ...
    public ResponseEntity<List<SocialMediaDto>> getAllSocialsForUser(
        ...
        System.out.println("Fetching social media links for user: " + principal.getId());
    ...
    public ResponseEntity<SocialMediaDto> createSocialMediaForUser(
        ...
        var locationUri = uriComponentsBuilder
                .path("/business-profiles/socialMedia/{id}")
